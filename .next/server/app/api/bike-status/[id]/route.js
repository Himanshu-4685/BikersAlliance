"use strict";(()=>{var e={};e.id=9865,e.ids=[9865],e.modules={30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},13685:e=>{e.exports=require("http")},95687:e=>{e.exports=require("https")},85477:e=>{e.exports=require("punycode")},12781:e=>{e.exports=require("stream")},57310:e=>{e.exports=require("url")},59796:e=>{e.exports=require("zlib")},6624:(e,t,r)=>{r.r(t),r.d(t,{headerHooks:()=>m,originalPathname:()=>b,requestAsyncStorage:()=>c,routeModule:()=>l,serverHooks:()=>_,staticGenerationAsyncStorage:()=>p,staticGenerationBailout:()=>g});var s={};r.r(s),r.d(s,{DELETE:()=>DELETE,GET:()=>GET,PUT:()=>PUT});var a=r(10884),n=r(16132),i=r(95798),u=r(32079);let o=process.env.SUPABASE_SERVICE_ROLE_KEY,d=(0,u.eI)("https://csvzysxiuuzcsmpknehi.supabase.co",o);async function PUT(e,{params:t}){try{let r=await e.json(),s=parseInt(t.id);if(isNaN(s))return i.Z.json({error:"Invalid status ID"},{status:400});let{brand_id:a,model_id:n,variant_id:u,status:o,price_range:l,expected_launch:c,launch_date:p}=r;if(!a||!n||!u||!o||!l)return i.Z.json({error:"Missing required fields"},{status:400});if(!["upcoming","new_launch"].includes(o))return i.Z.json({error:'Invalid status. Must be "upcoming" or "new_launch"'},{status:400});let _={brand_id:a,model_id:n,variant_id:u,status:o,price_range:l,updated_at:new Date().toISOString()};"upcoming"===o&&c&&(_.expected_launch=c,_.launch_date=null),"new_launch"===o&&p&&(_.launch_date=p,_.expected_launch=null);let{data:m,error:g}=await d.from("status").update(_).eq("status_id",s).select().single();if(g)return console.error("Error updating bike status:",g),i.Z.json({error:"Failed to update bike status"},{status:500});if(!m)return i.Z.json({error:"Bike status not found"},{status:404});return i.Z.json({success:!0,data:m,message:"Bike status updated successfully"})}catch(e){return console.error("Unexpected error:",e),i.Z.json({error:"Internal server error"},{status:500})}}async function DELETE(e,{params:t}){try{let e=parseInt(t.id);if(isNaN(e))return i.Z.json({error:"Invalid status ID"},{status:400});let{error:r}=await d.from("status").delete().eq("status_id",e);if(r)return console.error("Error deleting bike status:",r),i.Z.json({error:"Failed to delete bike status"},{status:500});return i.Z.json({success:!0,message:"Bike status deleted successfully"})}catch(e){return console.error("Unexpected error:",e),i.Z.json({error:"Internal server error"},{status:500})}}async function GET(e,{params:t}){try{let e=parseInt(t.id);if(isNaN(e))return i.Z.json({error:"Invalid status ID"},{status:400});let{data:r,error:s}=await d.from("status").select(`
        status_id,
        status,
        price_range,
        expected_launch,
