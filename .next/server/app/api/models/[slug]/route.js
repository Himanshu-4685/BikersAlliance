"use strict";(()=>{var e={};e.id=7289,e.ids=[7289],e.modules={30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},13685:e=>{e.exports=require("http")},95687:e=>{e.exports=require("https")},85477:e=>{e.exports=require("punycode")},12781:e=>{e.exports=require("stream")},57310:e=>{e.exports=require("url")},59796:e=>{e.exports=require("zlib")},94784:(e,r,a)=>{a.r(r),a.d(r,{headerHooks:()=>c,originalPathname:()=>p,requestAsyncStorage:()=>s,routeModule:()=>l,serverHooks:()=>u,staticGenerationAsyncStorage:()=>m,staticGenerationBailout:()=>_});var t={};a.r(t),a.d(t,{GET:()=>GET});var i=a(10884),o=a(16132),n=a(75639),d=a(58069);async function GET(e,r){try{let{slug:a}=r.params,t=(0,n.e)(),i=new URL(e.url);i.searchParams.get("cityId");let{data:o,error:l}=await t.from("models").select(`
        model_id,
        model_name,
        brand_id
