    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Error Loading Body Types</h1>
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-4">
          <nav className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span className="text-gray-900 font-medium">Body Types</span>
          </nav>
        </div>
      </div>
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mt-4 text-sm text-gray-600">
            {filteredBodyTypes.length} body type{filteredBodyTypes.length !== 1 ? 's' : ''} found
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        {filteredBodyTypes.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No body types found</h3>
            <p className="text-gray-600 mb-4">
              Try adjusting your search term to find body types
            </p>
            <button
