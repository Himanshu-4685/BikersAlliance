...
import { FiUpload, FiCamera, FiCheck, FiInfo } from 'react-icons/fi';
  ...
  const renderStep4 = () => (
    <div className="space-y-6">
      ...
      <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
        ...
        <label className="inline-flex items-center px-6 py-3 bg-red-500 text-white rounded-lg hover:bg-red-600 cursor-pointer">
